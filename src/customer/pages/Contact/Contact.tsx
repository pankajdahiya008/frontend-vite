                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-2">
                      Seller Support: <br />
                      <a href="tel:+1-800-SELL-NOW" className="text-blue-600 hover:underline">
                        +1 (800) SELL-NOW
                      </a>
                    </p>
                  </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    type="submit"
                    className="bg-blue-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 outline-none transition-colors"
                  >
                    Send Message
                  </button>
                </div>
            ...
            <div className="mt-8 bg-gray-100 rounded-lg p-8">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600 text-sm mt-1">Standard shipping takes 3-5 business days, while express shipping takes 1-2 business days.</p>
                </div>
                <div>
                  <h4 className="font-semibold text-gray-900">What is your return policy?</h4>
                  <p className="text-gray-600 text-sm mt-1">We offer a 30-day return policy for most items. Items must be in original condition.</p>
                </div>
                <div>
                  <h4 className="font-semibold text-gray-900">How do I become a seller?</h4>
                  <p className="text-gray-600 text-sm mt-1">Visit our "Become a Seller" page to start the registration process. It takes 2-3 business days for approval.</p>
                </div>
              </div>
            </div>
          </div>
